# 상품의 분석 카테고리에 설정된 속성들을 기준으로 상품을 분석하는 코드
# 분석 가능한 의견이 없는 경우
...
NO_OVERALL_KEEP = "유지할 만한 긍정 의견이 없습니다."
NO_OVERALL_IMPROVEMENT = "우선적으로 개선이 필요한 의견이 없습니다."
NO_OVERALL_SUMMARY = "종합 평가를 생성할 수 있는 리뷰가 충분하지 않습니다."
...
def get_target_product_ids(
    ...
    """
    실제 분석 문장이 존재하면서 오늘 아직 LLM 분석에 성공하지 않은
    상품 ID를 조회합니다.

    llm_analyzed_at이 NULL이거나 오늘보다 이전 날짜인 상품만 대상입니다.
    """
...
def group_rows_by_attribute(
    ...
    for attribute in all_attributes:
        key = (
            ...
            attribute["model_attribute_name"],
        )
