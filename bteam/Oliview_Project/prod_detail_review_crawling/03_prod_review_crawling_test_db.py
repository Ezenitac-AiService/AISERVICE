# products 테이블에서 리뷰 미수집 활성 상품 3개 조회
# 상품별 최신순/도움순/평점높은순/평점낮은순 리뷰 수집
# review_id 기준 중복 제거 후 reviews 테이블에 직접 저장
# 상품별 저장이 정상 완료되면 products.review_checked_at 갱신
...
def insert_reviews(
    ...
    review_id가 이미 존재하면 중복 오류를 내지 않고
    기존 행을 유지합니다.
