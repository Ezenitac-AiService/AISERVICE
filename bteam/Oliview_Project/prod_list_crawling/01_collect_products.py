...
def wait_for_cloudflare(page: Page, max_wait_seconds: int = 120) -> None:
    """
    Cloudflare 화면이 나타난 경우 사용자가 브라우저에서 직접 해결할 수 있도록
    일정 시간 기다립니다.
    """
    ...
    print()
    print("  ⚠️ 로봇 확인 또는 Cloudflare 화면이 감지되었습니다.")
    print("  ⚠️ 열린 브라우저에서 인증을 완료해 주세요.")
