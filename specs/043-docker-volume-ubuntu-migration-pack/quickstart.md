...
4. `GET http://localhost:8090/v1/models` $\rightarrow$ BGE-M3 Dense 임베딩 서비스 (HTTP 200)
5. `GET http://localhost:8091/v1/models` $\rightarrow$ BGE-Reranker-v2-m3 리랭킹 서비스 (HTTP 200)
